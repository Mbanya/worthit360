...
<head>
    ...
    <link rel='stylesheet' href='content/webdesign/css/structure.css'>
    <link rel='stylesheet' href='content/webdesign/css/webdesign.css'>
    <link rel='stylesheet' href='content/webdesign/css/custom.css'>
                    ...
                    <div id="rev_slider_1_2" class="rev_slider fullscreenbanner" data-version="5.0.4.1">
                        <ul>
                            <li data-index="rs-1" data-transition="fade" data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="Slide" data-description="">
                                <img src="content/webdesign/images/ken-tomita-239357-min.jpg" alt="" width="1920" height="1200" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
...
<script>
    jQuery(window).load(function() {
        ...
        if (retina) {
            ...
            retinaEl.attr("src", "content/webdesign/images/retina-webdesign.png").width(retinaLogoW).height(retinaLogoH);
            var stickyEl = jQuery("#logo img.logo-sticky");
            var stickyLogoW = stickyEl.width();
            var stickyLogoH = stickyEl.height();
            stickyEl.attr("src", "content/webdesign/images/retina-webdesign.png").width(stickyLogoW).height(stickyLogoH);
        }
    });
</script>
